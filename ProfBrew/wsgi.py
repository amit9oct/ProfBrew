"""
WSGI config for ProfBrew project.
...
activate_this = '/home/profbrew/.virtualenvs/rango/bin/activate_this.py'
...
os.environ['DJANGO_SETTINGS_MODULE'] = 'ProfBrew.settings'
